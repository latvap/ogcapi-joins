...
|2026-07-07|1.0.0  |P. Latvala | all | Changed the join resources under collections. Edited data joining operation set. Removed join outputs. Edited tests and schemas.
