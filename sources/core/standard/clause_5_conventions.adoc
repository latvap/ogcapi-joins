...
<|join-sources | Refers to a resource that is comprised of the metadata of the created join sources of the specific collection that is available on the server.
<|join-source |  Refers to a resource that is comprised of the metadata of the specific join source of the specific collection that is available on the server.
|===
