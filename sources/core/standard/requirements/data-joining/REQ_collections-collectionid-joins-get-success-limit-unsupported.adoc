[[req_data_joining_collections-collectionid-joins-success-limit-unsupported]]

[requirement]
====
[%metadata]
identifier:: /req/data-joining/collections-collectionid-joins-get-success-limit-unsupported
