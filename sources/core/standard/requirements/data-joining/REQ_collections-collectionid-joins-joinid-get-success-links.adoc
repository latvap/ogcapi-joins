[[req_data_joining_collections-collectionid-joins-joinid-get-success-links]]

[requirement]
====
[%metadata]
identifier:: /req/data-joining/collections-collectionid-joins-joinid-get-success-links
