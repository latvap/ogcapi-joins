[[req_data_joining_collections-collectionid-joins-get-success-limit-response]]

[requirement]
====
[%metadata]
identifier:: /req/data-joining/collections-collectionid-joins-get-success-limit
